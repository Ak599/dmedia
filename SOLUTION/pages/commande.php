...
<div class="conatainer mt-3">
            <div class="card-body">
               <form method = "POST" action = "../traitement/commande.php" >
                ...
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">Id_BF</label>
                    <input type="number" class="form-control" name="idBF"  >
                </div>
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">Numero_Facture</label>
                    <input type="number" class="form-control" name="numF"  >
                </div>
