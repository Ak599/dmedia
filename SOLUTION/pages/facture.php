...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-ka7Sk0Gln4gmtz2MlQnikT1wXgYsOg+OMhuP+IlRH9sENBO0LRn5q+8nbTov4+1p" crossorigin="anonymous"></script>
 ...
 <div class='alert alert-success corner-radius container mt-3'>
   <p>Facture ajouté avec succes !!</p>
 </div>
 <?php unset($_GET['success']);
          ...
          <div class="conatainer mt-3">
            <div class="card-body">
               <form method = "POST" action = "../traitement/facture.php" >
                ...
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">num_Reglement</label>
                    <input type="text" class="form-control" name="numR"  >
                </div>
